...
import { GlobeAltIcon, Bars3Icon, UserCircleIcon, MagnifyingGlassIcon } from "@heroicons/react/24/outline";
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-sm transition-all duration-500 ease-in-out">
      ...
      <DesktopSearchBar showSearchBar={showSearchBar} />
      <div className="md:hidden flex justify-center px-4 py-2">
        ...
        >
          ...
          <span className="font-semibold text-gray-800 truncate">Start your search</span>
        </button>
      </div>
